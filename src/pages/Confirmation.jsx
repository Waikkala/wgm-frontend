      ...
      <div className="confirmation-page-wrapper">
        ...
        <section className="confirmation-banner-card">
          <div className="confirmation-banner-content">
            <h1 className="confirmation-banner-title">Complete Your Raga Reserve Order</h1>
          </div>
        </section>
                ...
                <div className="confirmation-visual">
                  ...
                  <div className="success-badge">
                    <svg viewBox="0 0 100 100" width="90" height="90">
                      <circle cx="50" cy="50" r="45" fill="#1a4d3a" stroke="#FFD700" strokeWidth="4" />
                      <path d="M30 50 L45 65 L70 35" stroke="#FFD700" strokeWidth="7" fill="none" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  ...
                  <div className="confirmation-buttons">
                    <button className="btn-download" onClick={handleDownloadDetails}>
